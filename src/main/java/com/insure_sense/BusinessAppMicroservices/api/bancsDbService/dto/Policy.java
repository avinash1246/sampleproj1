...
public class Policy {
    ...
    private List<InsurableObject> insurableObjects;
    ...
    private List<PolicyPremiumSummary> premiumSummaryList;
    ...
    private List<QuoteOptions> quoteOptions;
    ...
    public List<InsurableObject> getInsurableObjects() {
        return insurableObjects;
    }

    public void setInsurableObjects(List<InsurableObject> insurableObjects) {
        this.insurableObjects = insurableObjects;
    }
    ...
    public List<PolicyPremiumSummary> getPremiumSummaryList() {
        return premiumSummaryList;
    }

    public void setPremiumSummaryList(List<PolicyPremiumSummary> premiumSummaryList) {
	...
	public List<QuoteOptions> getQuoteOptions() {
		return quoteOptions;
	}

	public void setQuoteOptions(List<QuoteOptions> quoteOptions) {
